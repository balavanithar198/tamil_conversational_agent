...
AFTER CALLER SAYS "OK" / "SERI" DURING A HOLD:
  ...
  Examples:
  "Wait pannadhuku thanks nga — unga order dispatch aachu,today evening delivery varum."
  "Konjam wait pannigathuku nandri nga — andha branch address Shop C42, Anna Nagar, Chennai."
  "Sorry for the wait nga — unga refund 3 to 5 days-la account-la varum."
